...
contract BurnablePausableERC20Token is PausableERC20Token {
        ...
        whenNotPaused
    {
        ...
        allowedBurn[_from][msg.sender] = allowedBurn[_from][msg.sender] - (_value);
        _burn(_from, _value);
    }
        ...
        returns (bool)
    {
        ...
        allowedBurn[msg.sender][_spender] + (_addedValue));
        ...
        returns (bool)
    {
        ...
        if (_subtractedValue >= oldValue) {
            ...
            allowedBurn[msg.sender][_spender] = oldValue - (_subtractedValue);
        }
        emit ApprovalBurn(msg.sender, _spender, allowedBurn[msg.sender][_spender]);
        return true;
    }
