...
// Contract: LAAR
// Pair:     resetClaimLimit vs transfer
// Mode:     race
...
// ===== TOD harness =====
// ----- resetClaimLimit vs transfer -----
// Shared state variables (touched by both):
//   - claimLimits
//   - balances
contract TOD_resetClaimLimit_transfer {
    function test(
        LAAR c1,
        LAAR c2,
        address a__address,
        ...
        // Order 1: c1 runs resetClaimLimit then transfer
        c1.resetClaimLimit(a__address);
        try c1.transfer(b__address, b__tokens) {} catch {}

        // Order 2: c2 runs transfer then resetClaimLimit
