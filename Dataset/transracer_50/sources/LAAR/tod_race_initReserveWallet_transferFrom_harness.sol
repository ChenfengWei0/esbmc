...
// Contract: LAAR
// Pair:     initReserveWallet vs transferFrom
// Mode:     race
...
// ===== TOD harness =====
// ----- initReserveWallet vs transferFrom -----
// Shared state variables (touched by both):
//   - balances
contract TOD_initReserveWallet_transferFrom {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs initReserveWallet then transferFrom
        try c1.initReserveWallet(a__reserveWallet) {} catch {}
        try c1.transferFrom(b__from, b__to, b__value) {} catch {}

        // Order 2: c2 runs transferFrom then initReserveWallet
