...
// Contract: LAAR
// Pair:     pauseCrowdSale vs transfer
// Mode:     race
...
// ===== TOD harness =====
// ----- pauseCrowdSale vs transfer -----
// Shared state variables (touched by both):
//   - stopped
//   - balances
contract TOD_pauseCrowdSale_transfer {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs pauseCrowdSale then transfer
        c1.pauseCrowdSale();
        try c1.transfer(b__address, b__tokens) {} catch {}

        // Order 2: c2 runs transfer then pauseCrowdSale
