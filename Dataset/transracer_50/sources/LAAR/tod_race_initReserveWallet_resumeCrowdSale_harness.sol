...
// Contract: LAAR
// Pair:     initReserveWallet vs resumeCrowdSale
// Mode:     race
...
// ===== TOD harness =====
// ----- initReserveWallet vs resumeCrowdSale -----
// Shared state variables (touched by both):
//   - stopped
//   - balances
contract TOD_initReserveWallet_resumeCrowdSale {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs initReserveWallet then resumeCrowdSale
        try c1.initReserveWallet(a__reserveWallet) {} catch {}
        c1.resumeCrowdSale();

        // Order 2: c2 runs resumeCrowdSale then initReserveWallet
        c2.resumeCrowdSale();
