...
// Contract: LAAR
// Pair:     setClaimLimit vs transfer
// Mode:     race
...
// ===== TOD harness =====
// ----- setClaimLimit vs transfer -----
// Shared state variables (touched by both):
//   - claimLimits
//   - balances
contract TOD_setClaimLimit_transfer {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs setClaimLimit then transfer
        try c1.setClaimLimit(a__address, a__days) {} catch {}
        try c1.transfer(b__address, b__tokens) {} catch {}

        // Order 2: c2 runs transfer then setClaimLimit
        try c2.transfer(b__address, b__tokens) {} catch {}
