...
// Contract: LAAR
// Pair:     decreaseApproval vs resumeCrowdSale
// Mode:     race
...
// ===== TOD harness =====
// ----- decreaseApproval vs resumeCrowdSale -----
// Shared state variables (touched by both):
//   - stopped
contract TOD_decreaseApproval_resumeCrowdSale {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs decreaseApproval then resumeCrowdSale
        try c1.decreaseApproval(a__spender, a__subtractedValue) {} catch {}
        c1.resumeCrowdSale();

        // Order 2: c2 runs resumeCrowdSale then decreaseApproval
        c2.resumeCrowdSale();
