...
// Contract: LAAR
// Pair:     transfer vs transferOwnership
// Mode:     race
...
// ===== TOD harness =====
// ----- transfer vs transferOwnership -----
// Shared state variables (touched by both):
//   - owner
//   - balances
contract TOD_transfer_transferOwnership {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs transfer then transferOwnership
        try c1.transfer(a__address, a__tokens) {} catch {}
        try c1.transferOwnership(b__newOwner) {} catch {}

        // Order 2: c2 runs transferOwnership then transfer
