...
// Contract: LAAR
// Pair:     resetClaimLimit vs transferOwnership
// Mode:     race
...
// ===== TOD harness =====
// ----- resetClaimLimit vs transferOwnership -----
// Shared state variables (touched by both):
//   - owner
//   - claimLimits
//   - balances
contract TOD_resetClaimLimit_transferOwnership {
    function test(
        LAAR c1,
        LAAR c2,
        address a__address,
        ...
        // Order 1: c1 runs resetClaimLimit then transferOwnership
        c1.resetClaimLimit(a__address);
        try c1.transferOwnership(b__newOwner) {} catch {}

        // Order 2: c2 runs transferOwnership then resetClaimLimit
