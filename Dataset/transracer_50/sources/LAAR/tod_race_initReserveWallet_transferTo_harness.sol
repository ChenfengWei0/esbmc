...
// Contract: LAAR
// Pair:     initReserveWallet vs transferTo
// Mode:     race
...
// ===== TOD harness =====
// ----- initReserveWallet vs transferTo -----
// Shared state variables (touched by both):
//   - balances
contract TOD_initReserveWallet_transferTo {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs initReserveWallet then transferTo
        try c1.initReserveWallet(a__reserveWallet) {} catch {}
        try c1.transferTo(b__address, b__tokens) {} catch {}

        // Order 2: c2 runs transferTo then initReserveWallet
