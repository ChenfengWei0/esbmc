...
// Contract: LAAR
// Pair:     decreaseApproval vs pauseCrowdSale
// Mode:     race
...
// ===== TOD harness =====
// ----- decreaseApproval vs pauseCrowdSale -----
// Shared state variables (touched by both):
//   - stopped
contract TOD_decreaseApproval_pauseCrowdSale {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs decreaseApproval then pauseCrowdSale
        try c1.decreaseApproval(a__spender, a__subtractedValue) {} catch {}
        c1.pauseCrowdSale();

        // Order 2: c2 runs pauseCrowdSale then decreaseApproval
        c2.pauseCrowdSale();
