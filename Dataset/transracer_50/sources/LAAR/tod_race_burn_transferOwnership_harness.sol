...
// Contract: LAAR
// Pair:     burn vs transferOwnership
// Mode:     race
...
// ===== TOD harness =====
// ----- burn vs transferOwnership -----
// Shared state variables (touched by both):
//   - totalTokenSupply
//   - owner
//   - totalBurned
//   - balances
contract TOD_burn_transferOwnership {
    function test(
        LAAR c1,
        LAAR c2,
        uint256 a__value,
        ...
        // Order 1: c1 runs burn then transferOwnership
        try c1.burn(a__value) {} catch {}
        try c1.transferOwnership(b__newOwner) {} catch {}

        // Order 2: c2 runs transferOwnership then burn
