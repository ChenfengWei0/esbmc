...
// Contract: LAAR
// Pair:     pauseCrowdSale vs transferOwnership
// Mode:     race
...
// ===== TOD harness =====
// ----- pauseCrowdSale vs transferOwnership -----
// Shared state variables (touched by both):
//   - owner
//   - stopped
//   - balances
contract TOD_pauseCrowdSale_transferOwnership {
    function test(
        LAAR c1,
        LAAR c2,
        address b__newOwner
        ...
        // Order 1: c1 runs pauseCrowdSale then transferOwnership
        c1.pauseCrowdSale();
        try c1.transferOwnership(b__newOwner) {} catch {}

        // Order 2: c2 runs transferOwnership then pauseCrowdSale
