...
// Contract: LAAR
// Pair:     decreaseApproval vs increaseApproval
// Mode:     race
...
// ===== TOD harness =====
// ----- decreaseApproval vs increaseApproval -----
// Shared state variables (touched by both):
//   <none — assertion is trivially true>
contract TOD_decreaseApproval_increaseApproval {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs decreaseApproval then increaseApproval
        try c1.decreaseApproval(a__spender, a__subtractedValue) {} catch {}
        try c1.increaseApproval(b__spender, b__addedValue) {} catch {}

        // Order 2: c2 runs increaseApproval then decreaseApproval
        try c2.increaseApproval(b__spender, b__addedValue) {} catch {}
