...
// Contract: LAAR
// Pair:     burn vs initReserveWallet
// Mode:     race
...
// ===== TOD harness =====
// ----- burn vs initReserveWallet -----
// Shared state variables (touched by both):
//   - totalTokenSupply
//   - totalBurned
//   - balances
contract TOD_burn_initReserveWallet {
    function test(
        LAAR c1,
        LAAR c2,
        uint256 a__value,
        ...
        // Order 1: c1 runs burn then initReserveWallet
        try c1.burn(a__value) {} catch {}
        try c1.initReserveWallet(b__reserveWallet) {} catch {}

        // Order 2: c2 runs initReserveWallet then burn
