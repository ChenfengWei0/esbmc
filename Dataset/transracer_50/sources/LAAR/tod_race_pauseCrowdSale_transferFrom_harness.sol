...
// Contract: LAAR
// Pair:     pauseCrowdSale vs transferFrom
// Mode:     race
...
// ===== TOD harness =====
// ----- pauseCrowdSale vs transferFrom -----
// Shared state variables (touched by both):
//   - stopped
//   - balances
contract TOD_pauseCrowdSale_transferFrom {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs pauseCrowdSale then transferFrom
        c1.pauseCrowdSale();
        try c1.transferFrom(b__from, b__to, b__value) {} catch {}

        // Order 2: c2 runs transferFrom then pauseCrowdSale
