...
// Contract: LAAR
// Pair:     resetClaimLimit vs setClaimLimit
// Mode:     race
...
// ===== TOD harness =====
// ----- resetClaimLimit vs setClaimLimit -----
// Shared state variables (touched by both):
//   - claimLimits
contract TOD_resetClaimLimit_setClaimLimit {
    function test(
        LAAR c1,
        LAAR c2,
        address a__address,
        ...
        // Order 1: c1 runs resetClaimLimit then setClaimLimit
        c1.resetClaimLimit(a__address);
        try c1.setClaimLimit(b__address, b__days) {} catch {}

        // Order 2: c2 runs setClaimLimit then resetClaimLimit
