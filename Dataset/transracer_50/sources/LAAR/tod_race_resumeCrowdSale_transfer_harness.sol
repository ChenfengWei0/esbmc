...
// Contract: LAAR
// Pair:     resumeCrowdSale vs transfer
// Mode:     race
...
// ===== TOD harness =====
// ----- resumeCrowdSale vs transfer -----
// Shared state variables (touched by both):
//   - stopped
//   - balances
contract TOD_resumeCrowdSale_transfer {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs resumeCrowdSale then transfer
        c1.resumeCrowdSale();
        try c1.transfer(b__address, b__tokens) {} catch {}

        // Order 2: c2 runs transfer then resumeCrowdSale
