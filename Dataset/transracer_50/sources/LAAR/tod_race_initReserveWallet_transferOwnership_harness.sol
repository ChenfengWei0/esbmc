...
// Contract: LAAR
// Pair:     initReserveWallet vs transferOwnership
// Mode:     race
...
// ===== TOD harness =====
// ----- initReserveWallet vs transferOwnership -----
// Shared state variables (touched by both):
//   - owner
//   - balances
contract TOD_initReserveWallet_transferOwnership {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs initReserveWallet then transferOwnership
        try c1.initReserveWallet(a__reserveWallet) {} catch {}
        try c1.transferOwnership(b__newOwner) {} catch {}

        // Order 2: c2 runs transferOwnership then initReserveWallet
