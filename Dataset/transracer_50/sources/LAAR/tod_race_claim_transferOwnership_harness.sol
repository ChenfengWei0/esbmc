...
// Contract: LAAR
// Pair:     claim vs transferOwnership
// Mode:     race
...
// ===== TOD harness =====
// ----- claim vs transferOwnership -----
// Shared state variables (touched by both):
//   - owner
//   - balances
contract TOD_claim_transferOwnership {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs claim then transferOwnership
        try c1.claim(a__recipient) {} catch {}
        try c1.transferOwnership(b__newOwner) {} catch {}

        // Order 2: c2 runs transferOwnership then claim
