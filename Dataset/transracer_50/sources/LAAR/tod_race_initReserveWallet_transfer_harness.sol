...
// Contract: LAAR
// Pair:     initReserveWallet vs transfer
// Mode:     race
...
// ===== TOD harness =====
// ----- initReserveWallet vs transfer -----
// Shared state variables (touched by both):
//   - balances
contract TOD_initReserveWallet_transfer {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs initReserveWallet then transfer
        try c1.initReserveWallet(a__reserveWallet) {} catch {}
        try c1.transfer(b__address, b__tokens) {} catch {}

        // Order 2: c2 runs transfer then initReserveWallet
