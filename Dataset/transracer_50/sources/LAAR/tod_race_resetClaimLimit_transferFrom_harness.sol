...
// Contract: LAAR
// Pair:     resetClaimLimit vs transferFrom
// Mode:     race
...
// ===== TOD harness =====
// ----- resetClaimLimit vs transferFrom -----
// Shared state variables (touched by both):
//   - claimLimits
//   - balances
contract TOD_resetClaimLimit_transferFrom {
    function test(
        LAAR c1,
        LAAR c2,
        address a__address,
        ...
        // Order 1: c1 runs resetClaimLimit then transferFrom
        c1.resetClaimLimit(a__address);
        try c1.transferFrom(b__from, b__to, b__value) {} catch {}

        // Order 2: c2 runs transferFrom then resetClaimLimit
        try c2.transferFrom(b__from, b__to, b__value) {} catch {}
        c2.resetClaimLimit(a__address);
