...
// Contract: LAAR
// Pair:     approve vs resumeCrowdSale
// Mode:     race
...
// ===== TOD harness =====
// ----- approve vs resumeCrowdSale -----
// Shared state variables (touched by both):
//   - stopped
contract TOD_approve_resumeCrowdSale {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs approve then resumeCrowdSale
        try c1.approve(a__spender, a__tokens) {} catch {}
        c1.resumeCrowdSale();

        // Order 2: c2 runs resumeCrowdSale then approve
        c2.resumeCrowdSale();
