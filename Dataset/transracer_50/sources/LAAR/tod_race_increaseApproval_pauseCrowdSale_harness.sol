...
// Contract: LAAR
// Pair:     increaseApproval vs pauseCrowdSale
// Mode:     race
...
// ===== TOD harness =====
// ----- increaseApproval vs pauseCrowdSale -----
// Shared state variables (touched by both):
//   - stopped
contract TOD_increaseApproval_pauseCrowdSale {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs increaseApproval then pauseCrowdSale
        try c1.increaseApproval(a__spender, a__addedValue) {} catch {}
        c1.pauseCrowdSale();

        // Order 2: c2 runs pauseCrowdSale then increaseApproval
        c2.pauseCrowdSale();
