...
// Contract: LAAR
// Pair:     resumeCrowdSale vs transferFrom
// Mode:     race
...
// ===== TOD harness =====
// ----- resumeCrowdSale vs transferFrom -----
// Shared state variables (touched by both):
//   - stopped
//   - balances
contract TOD_resumeCrowdSale_transferFrom {
    function test(
        LAAR c1,
        LAAR c2,
