...
// ===== TOD harness =====
// ----- burn vs setClaimLimit -----
// Shared state variables (touched by both):
//   - totalTokenSupply
//   - totalBurned
//   - claimLimits
//   - balances
contract TOD_burn_setClaimLimit {
    function test(
        LAAR c1,
        LAAR c2,
        uint256 a__value,
        ...
        // Order 1: c1 runs burn then setClaimLimit
        try c1.burn(a__value) {} catch {}
        try c1.setClaimLimit(b__address, b__days) {} catch {}

        // Order 2: c2 runs setClaimLimit then burn
