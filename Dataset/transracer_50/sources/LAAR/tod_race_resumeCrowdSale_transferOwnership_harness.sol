...
// Contract: LAAR
// Pair:     resumeCrowdSale vs transferOwnership
// Mode:     race
...
// ===== TOD harness =====
// ----- resumeCrowdSale vs transferOwnership -----
// Shared state variables (touched by both):
//   - owner
//   - stopped
//   - balances
contract TOD_resumeCrowdSale_transferOwnership {
    function test(
        LAAR c1,
        LAAR c2,
        address b__newOwner
        ...
        // Order 1: c1 runs resumeCrowdSale then transferOwnership
        c1.resumeCrowdSale();
        try c1.transferOwnership(b__newOwner) {} catch {}

        // Order 2: c2 runs transferOwnership then resumeCrowdSale
