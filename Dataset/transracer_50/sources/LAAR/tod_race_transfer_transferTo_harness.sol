...
// ===== TOD harness =====
// ----- transfer vs transferTo -----
// Shared state variables (touched by both):
//   - balances
contract TOD_transfer_transferTo {
    function test(
        LAAR c1,
        LAAR c2,
