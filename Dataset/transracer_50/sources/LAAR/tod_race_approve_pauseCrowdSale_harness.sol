...
// Contract: LAAR
// Pair:     approve vs pauseCrowdSale
// Mode:     race
...
// ===== TOD harness =====
// ----- approve vs pauseCrowdSale -----
// Shared state variables (touched by both):
//   - stopped
contract TOD_approve_pauseCrowdSale {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs approve then pauseCrowdSale
        try c1.approve(a__spender, a__tokens) {} catch {}
        c1.pauseCrowdSale();

        // Order 2: c2 runs pauseCrowdSale then approve
        c2.pauseCrowdSale();
