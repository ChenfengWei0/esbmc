...
// ===== TOD harness =====
// ----- claim vs resetClaimLimit -----
// Shared state variables (touched by both):
//   - claimLimits
//   - balances
contract TOD_claim_resetClaimLimit {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs claim then resetClaimLimit
        try c1.claim(a__recipient) {} catch {}
        c1.resetClaimLimit(b__address);

        // Order 2: c2 runs resetClaimLimit then claim
        c2.resetClaimLimit(b__address);
