...
// ===== TOD harness =====
// ----- burn vs resumeCrowdSale -----
// Shared state variables (touched by both):
//   - totalTokenSupply
//   - totalBurned
//   - stopped
//   - balances
contract TOD_burn_resumeCrowdSale {
    function test(
        LAAR c1,
        LAAR c2,
        uint256 a__value
        ...
        // Order 1: c1 runs burn then resumeCrowdSale
        try c1.burn(a__value) {} catch {}
        c1.resumeCrowdSale();

        // Order 2: c2 runs resumeCrowdSale then burn
        c2.resumeCrowdSale();
