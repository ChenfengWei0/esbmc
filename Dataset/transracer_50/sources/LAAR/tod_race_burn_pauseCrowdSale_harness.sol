...
// ===== TOD harness =====
// ----- burn vs pauseCrowdSale -----
// Shared state variables (touched by both):
//   - totalTokenSupply
//   - totalBurned
//   - stopped
//   - balances
contract TOD_burn_pauseCrowdSale {
    function test(
        LAAR c1,
        LAAR c2,
        uint256 a__value
        ...
        // Order 1: c1 runs burn then pauseCrowdSale
        try c1.burn(a__value) {} catch {}
        c1.pauseCrowdSale();

        // Order 2: c2 runs pauseCrowdSale then burn
        c2.pauseCrowdSale();
