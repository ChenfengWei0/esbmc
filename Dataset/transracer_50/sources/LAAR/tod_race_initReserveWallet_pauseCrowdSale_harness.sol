...
// Contract: LAAR
// Pair:     initReserveWallet vs pauseCrowdSale
// Mode:     race
...
// ===== TOD harness =====
// ----- initReserveWallet vs pauseCrowdSale -----
// Shared state variables (touched by both):
//   - stopped
//   - balances
contract TOD_initReserveWallet_pauseCrowdSale {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs initReserveWallet then pauseCrowdSale
        try c1.initReserveWallet(a__reserveWallet) {} catch {}
        c1.pauseCrowdSale();

        // Order 2: c2 runs pauseCrowdSale then initReserveWallet
        c2.pauseCrowdSale();
