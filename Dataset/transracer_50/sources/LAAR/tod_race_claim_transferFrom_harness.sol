...
// ===== TOD harness =====
// ----- claim vs transferFrom -----
// Shared state variables (touched by both):
//   - balances
contract TOD_claim_transferFrom {
    function test(
        LAAR c1,
        LAAR c2,
