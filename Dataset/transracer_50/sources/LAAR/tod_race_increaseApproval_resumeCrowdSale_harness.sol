...
// Contract: LAAR
// Pair:     increaseApproval vs resumeCrowdSale
// Mode:     race
...
// ===== TOD harness =====
// ----- increaseApproval vs resumeCrowdSale -----
// Shared state variables (touched by both):
//   - stopped
contract TOD_increaseApproval_resumeCrowdSale {
    function test(
        LAAR c1,
        LAAR c2,
        ...
        // Order 1: c1 runs increaseApproval then resumeCrowdSale
        try c1.increaseApproval(a__spender, a__addedValue) {} catch {}
        c1.resumeCrowdSale();

        // Order 2: c2 runs resumeCrowdSale then increaseApproval
        c2.resumeCrowdSale();
