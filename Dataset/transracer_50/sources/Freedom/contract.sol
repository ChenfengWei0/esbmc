...
abstract contract ERC20 {
  ...
  function transferFrom(address from, address to, uint256 value) public virtual returns (bool ok);
  function approve(address spender, uint256 value) public virtual returns (bool ok);
  function transfer(address to, uint256 value) public virtual returns (bool ok);
