...
## The TODO lives in `VeriPUT/Notes/TODO.md`

The authoritative list of unfinished work is that file, named for what it is
rather than buried in a handoff narrative. Update it in the same patch that
completes or adds an item, and do not start a second list here.

The five blocking items the user set on 2026-08-20 -- multi-property batching,
removing the hollow ABI tests, not synthesising R1/R2 on a revert boundary,
solving the motivation example before any Full run, and the standing ban on
full-corpus runs -- are recorded there with their measured evidence.

What stays below is the narrative this file is for: what was run, what broke,
and what was ruled out. The closed entries are kept as evidence, not as tasks.

### Closed, kept as evidence
