...
contract FarmingPoolCovTest_FarmingPool_deposit is Test {
  ...
  // claim: sol:@C@FarmingPool@F@deposit#6613:path:247, sol:@C@FarmingPool@F@deposit#6613:path:246
  ...
  // claim: sol:@C@FarmingPool@F@deposit#6613:path:3623, sol:@C@FarmingPool@F@deposit#6613:path:3622
  // DISABLED: RED on the unmodified contract, so its
  // coverage is not ours to claim. Kept, renamed out of
  // forge's `test*` prefix, so the artefact still shows
  // what was generated.
