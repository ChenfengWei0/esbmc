...
contract ESBMCMock_IERC20_FarmingPoolCovTest_FarmingPool_distributor_put3 is IERC20 {
...
contract ESBMCMock_IERC20Metadata_FarmingPoolCovTest_FarmingPool_distributor_put3 is IERC20Metadata {
  function transferFrom(address, address, uint256) external pure override returns (bool) { return false; }
  function approve(address, uint256) external pure override returns (bool) { return false; }
  function allowance(address, address) external pure override returns (uint256) { return 0; }
  function transfer(address, uint256) external pure override returns (bool) { return false; }
...
contract FarmingPoolCovTest_FarmingPool_distributor_put3 is Test {
  ESBMCMock_IERC20Metadata_FarmingPoolCovTest_FarmingPool_distributor_put3 mk_IERC20Metadata_stakingToken_;
  ESBMCMock_IERC20_FarmingPoolCovTest_FarmingPool_distributor_put3 mk_IERC20_rewardsToken_;
  FarmingPool c0;
  function setUp() public {
    mk_IERC20Metadata_stakingToken_ = new ESBMCMock_IERC20Metadata_FarmingPoolCovTest_FarmingPool_distributor_put3();
    mk_IERC20_rewardsToken_ = new ESBMCMock_IERC20_FarmingPoolCovTest_FarmingPool_distributor_put3();
    c0 = new FarmingPool(mk_IERC20Metadata_stakingToken_, mk_IERC20_rewardsToken_, address(uint160(1)));
  }
  // claim: sol:@C@FarmingPool@F@distributor#5935:path:3
  function test_cov_0() public {
    // [asserted] path exits normally; a revert fails the test
    c0.distributor();
  }
  // claim: sol:@C@FarmingPool@F@distributor#5935:path:2
  function test_cov_1() public {
    ...
    (bool ok2, ) = address(c0).call{value: 1}(
        abi.encodeWithSignature("distributor()"));
    assertFalse(ok2, "value sent to a non-payable entry must revert");
  }

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@FarmingPool@F@distributor#5935:path:3   depth=1
  ...
  function test_put_FarmingPool_distributor_path3() public {
    ...
    // [asserted] path exits normally; a revert fails the test
    address _put_ret = c0.distributor();
