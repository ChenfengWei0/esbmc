...
contract ESBMCMock_IERC20_FarmingPoolCovTest_FarmingPool_transfer_put6 is IERC20 {
...
contract ESBMCMock_IERC20Metadata_FarmingPoolCovTest_FarmingPool_transfer_put6 is IERC20Metadata {
  function transferFrom(address, address, uint256) external pure override returns (bool) { return false; }
  function approve(address, uint256) external pure override returns (bool) { return false; }
  function allowance(address, address) external pure override returns (uint256) { return 0; }
  function transfer(address, uint256) external pure override returns (bool) { return false; }
...
contract FarmingPoolCovTest_FarmingPool_transfer_put6 is Test {
  ESBMCMock_IERC20Metadata_FarmingPoolCovTest_FarmingPool_transfer_put6 mk_IERC20Metadata_stakingToken_;
  ESBMCMock_IERC20_FarmingPoolCovTest_FarmingPool_transfer_put6 mk_IERC20_rewardsToken_;
  FarmingPool c0;
  function setUp() public {
    mk_IERC20Metadata_stakingToken_ = new ESBMCMock_IERC20Metadata_FarmingPoolCovTest_FarmingPool_transfer_put6();
    mk_IERC20_rewardsToken_ = new ESBMCMock_IERC20_FarmingPoolCovTest_FarmingPool_transfer_put6();
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@FarmingPool@F@transfer#1242:path:6   depth=2
  ...
  function test_put_FarmingPool_transfer_path6(address to, uint256 value) public {
