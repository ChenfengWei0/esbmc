...
contract ESBMCMock_IERC20_FarmingPoolCovTest_FarmingPool_transfer_put14 is IERC20 {
...
contract ESBMCMock_IERC20Metadata_FarmingPoolCovTest_FarmingPool_transfer_put14 is IERC20Metadata {
  function transferFrom(address, address, uint256) external pure override returns (bool) { return false; }
  function approve(address, uint256) external pure override returns (bool) { return false; }
  function allowance(address, address) external pure override returns (uint256) { return 0; }
  function transfer(address, uint256) external pure override returns (bool) { return false; }
...
contract FarmingPoolCovTest_FarmingPool_transfer_put14 is Test {
  ESBMCMock_IERC20Metadata_FarmingPoolCovTest_FarmingPool_transfer_put14 mk_IERC20Metadata_stakingToken_;
  ESBMCMock_IERC20_FarmingPoolCovTest_FarmingPool_transfer_put14 mk_IERC20_rewardsToken_;
  FarmingPool c0;
  function setUp() public {
    mk_IERC20Metadata_stakingToken_ = new ESBMCMock_IERC20Metadata_FarmingPoolCovTest_FarmingPool_transfer_put14();
    mk_IERC20_rewardsToken_ = new ESBMCMock_IERC20_FarmingPoolCovTest_FarmingPool_transfer_put14();
  ...
  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@FarmingPool@F@transfer#1242:path:14   depth=3
  ...
  function test_put_FarmingPool_transfer_path14(address to, uint256 value) public {
    to = address(uint160(bound(uint256(uint160(to)), 0, 0)));
