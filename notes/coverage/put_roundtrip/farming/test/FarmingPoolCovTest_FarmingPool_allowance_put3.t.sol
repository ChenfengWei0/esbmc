...
contract ESBMCMock_IERC20_FarmingPoolCovTest_FarmingPool_allowance_put3 is IERC20 {
...
contract ESBMCMock_IERC20Metadata_FarmingPoolCovTest_FarmingPool_allowance_put3 is IERC20Metadata {
  function transferFrom(address, address, uint256) external pure override returns (bool) { return false; }
  function approve(address, uint256) external pure override returns (bool) { return false; }
  function allowance(address, address) external pure override returns (uint256) { return 0; }
  function transfer(address, uint256) external pure override returns (bool) { return false; }
...
contract FarmingPoolCovTest_FarmingPool_allowance_put3 is Test {
  ESBMCMock_IERC20Metadata_FarmingPoolCovTest_FarmingPool_allowance_put3 mk_IERC20Metadata_stakingToken_;
  ESBMCMock_IERC20_FarmingPoolCovTest_FarmingPool_allowance_put3 mk_IERC20_rewardsToken_;
  FarmingPool c0;
  function setUp() public {
    mk_IERC20Metadata_stakingToken_ = new ESBMCMock_IERC20Metadata_FarmingPoolCovTest_FarmingPool_allowance_put3();
    mk_IERC20_rewardsToken_ = new ESBMCMock_IERC20_FarmingPoolCovTest_FarmingPool_allowance_put3();
    c0 = new FarmingPool(mk_IERC20Metadata_stakingToken_, mk_IERC20_rewardsToken_, address(uint160(1)));
  }
  // claim: sol:@C@FarmingPool@F@allowance#1259:path:3
  function test_cov_0() public {
    // [asserted] path exits normally; a revert fails the test
    c0.allowance(address(uint160(0)), address(uint160(0)));
  }
  // claim: sol:@C@FarmingPool@F@allowance#1259:path:2
  function test_cov_1() public {
    ...
    (bool ok2, ) = address(c0).call{value: 1}(
        abi.encodeWithSignature("allowance(address,address)", address(uint160(0)), address(uint160(0))));
    assertFalse(ok2, "value sent to a non-payable entry must revert");
  }

  // ===================== PUT (stage 4) =====================
  // claim: sol:@C@FarmingPool@F@allowance#1259:path:3   depth=1
  ...
  //   state._balances[owner] in [0, 0]
  //   state._balances[spender] in [0, 0]
  ...
  // FUZZ COORDINATES: owner, spender
  ...
  function test_put_FarmingPool_allowance_path3(address owner, address spender) public {
    ...
    //   state._balances[owner] := 0; state._balances[spender] := 0; state._distributor := 0; state._totalSupply := 0
    {
      uint256 _w = uint256(vm.load(address(c0), keccak256(abi.encode(owner, uint256(2)))));
      _w = (_w & ~uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)) | ((uint256(0) & 115792089237316195423570985008687907853269984665640564039457584007913129639935) << 0);
      vm.store(address(c0), keccak256(abi.encode(owner, uint256(2))), bytes32(_w));
    }
    {
      uint256 _w = uint256(vm.load(address(c0), keccak256(abi.encode(spender, uint256(2)))));
      _w = (_w & ~uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935)) | ((uint256(0) & 115792089237316195423570985008687907853269984665640564039457584007913129639935) << 0);
      vm.store(address(c0), keccak256(abi.encode(spender, uint256(2))), bytes32(_w));
    }
    {
    ...
    uint256 _pre_balances_spender = uint256(vm.load(address(c0), keccak256(abi.encode(spender, uint256(2)))));
    // [asserted] path exits normally; a revert fails the test
    c0.allowance(owner, spender);
    ...
    uint256 _post_balances_spender = uint256(vm.load(address(c0), keccak256(abi.encode(spender, uint256(2)))));
    ...
    assertGe(_post_balances_owner, _pre_balances_owner, "_balances[owner]: post >= pre");
    assertLe(_post_balances_owner, _pre_balances_owner, "_balances[owner]: post <= pre");
    assertEq(_post_balances_spender, _pre_balances_spender, "_balances[spender]: post == pre");
    assertGe(_post_balances_spender, _pre_balances_spender, "_balances[spender]: post >= pre");
    assertLe(_post_balances_spender, _pre_balances_spender, "_balances[spender]: post <= pre");
  }
}
