...
def main():
    ...
    ap.add_argument("--claim-budget", type=int, default=0,
                    help="cap the number of CLAIMS an outer-box round emits, "
                         ...
                         "quantity.\n"
                         "THERE IS NO PER-CLAIM RATE TO QUOTE, and an earlier "
                         "version of this help quoted one (~0.26s). It does not "
                         "reproduce: 64 claims took 16.6s and 192 claims took "
                         "14.1s on the same unit -- MORE claims, LESS wall "
                         "clock -- so the cost is not linear in claim count and "
                         "a single figure is not a property of the tool.\n"
